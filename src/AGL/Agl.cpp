...
//?rendering---------------------------------------------------------------------------------------------------------------------------------------
agl::Quad::Quad()
	:m_x(nullptr), m_y(nullptr), m_xScale(nullptr), m_yScale(nullptr), m_rotation(nullptr), m_vis(nullptr), m_color({255, 255, 255, 255}), m_VBO(0), m_EBO(0), m_VAO(0) {}
