...
Mat3f::Mat3f()
	:m00(1), m10(), m20(), m01(), m11(1), m21(), m02(), m12(), m22(1) {}
Mat3f::Mat3f(float v00, float v10, float v20, float v01, float v11, float v21, float v02, float v12, float v22)
	: m00(v00), m10(v10), m20(v20), m01(v01), m11(v11), m21(v21), m02(v02), m12(v12), m22(v22) {}
...
// std::string Mat3f::toString() const {
...
Mat3f Mat3f::transpose(const Mat3f& T) {
	return {T.m00, T.m01, T.m02, T.m10, T.m11, T.m12, T.m20, T.m21, T.m22};
}
...
Mat3f Mat3f::multiply(const Mat3f& A, const Mat3f& B) {
	return {A.m00 * B.m00 + A.m10 * B.m01 + A.m20 * B.m02,
