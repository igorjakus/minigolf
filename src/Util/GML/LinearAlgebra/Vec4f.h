...
struct Vec4f {
	...
	// 
	/////////////////////////////////////////////////////////////
	Vec4f(float xv, float yv, float zv, float wv);
	...
	// 
	/////////////////////////////////////////////////////////////
	[[nodiscard]] Vec4f normalized() const;
	...
	// 
	/////////////////////////////////////////////////////////////
	static Vec4f multiplyByScalar(const Vec4f&, float);
	...
	// 
	/////////////////////////////////////////////////////////////
	static Vec4f multiplyByScalar(float, const Vec4f&);
	...
	// 
	/////////////////////////////////////////////////////////////
	[[nodiscard]] float dotProduct(const Vec4f&) const;
...
Vec4f operator*(float, const Vec4f&); // vector scaling
Vec4f operator*(const Vec4f&, float); // vector scaling
Vec4f operator/(const Vec4f&, float); // vector scaling
